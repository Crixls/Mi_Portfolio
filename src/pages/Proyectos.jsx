...
const Proyectos = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-15 md:m-20 lg:m-30 m-10 lg:flex  md:flex md:mt-2 lg:mt-40 sm:grid-cols-1 ">

        {/* Tarjeta */}
        <div
          className={`
            backdrop-blur-xl border rounded-2xl p-8
            flex flex-col h-full md:p-4 md:min-h-40 md:mt-10 lg:w-200
